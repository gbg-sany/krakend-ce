...
docker:
	docker build --no-cache --pull --build-arg GOLANG_VERSION=${GOLANG_VERSION} --build-arg ALPINE_VERSION=${ALPINE_VERSION} -t fcsregistry.azurecr.io/unicorn/unicorn-krakend:${VERSION} .
